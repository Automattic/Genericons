...
(function( $ ){
    ...
    function suggestCode( attr, cssClass ) {
		...
		var fileLocation = 'genericons.svg',
            suggestion = '<svg class="genericon genericon-'+ cssClass +'" width="16px" height="16px"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="' + fileLocation + attr + '"></use></svg>';
